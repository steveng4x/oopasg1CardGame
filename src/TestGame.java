...
public class TestGame {
	public static void main(String[] args) {
		...
		Pokemon pokemon031 = new Pokemon("Primal Kyogre",50,1,40,0,"blue","Attacking","Judgement Storm","Active");
		Pokemon pokemon032 = new Pokemon("Primal Kyogre2",100,2,80,0,"blue","Attacking","Wind Walker Remorse","Active");		
